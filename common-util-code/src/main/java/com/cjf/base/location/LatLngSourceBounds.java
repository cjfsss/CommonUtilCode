...
public class LatLngSourceBounds {
    ...
    public static final class Builder {
        ...
        public LatLngSourceBounds.Builder include(LatLngSource var1) {
            if (var1 == null) {
                return this;
            } else {
                if (this.e) {
        ...
        public LatLngSourceBounds.Builder include(List<LatLngSource> var1) {
            if (var1 != null && var1.size() != 0) {
                ...
                while (var2.hasNext()) {
                    LatLngSource var3 = (LatLngSource) var2.next();
                    this.a(var3);
                }
                return this;
            } else {
        ...
        private void a(LatLngSource var1) {
            if (var1 != null) {
