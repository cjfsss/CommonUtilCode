...
/**
 * <p>Title: AppCompatTimePickerPopup </p>
 * <p>Description:  </p>
 ...
 */
public class AppCompatTimePickerPopup extends BottomPopupView {
    public enum Mode {
        YMDHMS, YMDHM, YMDH, YMD, YM, Y, MD, MDH, MDHM, MDHMS, DH, DHM, DHMS, HM, HMS
    }

    public TimePickerListener timePickerListener;
    private AppCompatTimePickerPopup.Mode mode = AppCompatTimePickerPopup.Mode.YMD;
    ...
    public AppCompatTimePickerPopup(@NonNull Context context) {
        super(context);
    }
    ...
    public boolean[] mode2type() {
        switch (mode) {
            ...
            case DH:// 日 小时
                return new boolean[]{false, false, true, true, false, false};
            case DHM:// 日 小时 分
    ...
    public AppCompatTimePickerPopup setTimePickerListener(TimePickerListener listener) {
        this.timePickerListener = listener;
        return this;
    }

    public AppCompatTimePickerPopup setItemTextSize(int textSize) {
        this.itemTextSize = textSize;
        return this;
    }

    public AppCompatTimePickerPopup setMode(AppCompatTimePickerPopup.Mode mode) {
        this.mode = mode;
        return this;
    }
     ...
     * @return
     */
    public AppCompatTimePickerPopup setLunar(boolean isLunar) {
        this.isLunar = isLunar;
        return this;
    }

    public AppCompatTimePickerPopup setItemsVisibleCount(int itemsVisibleCount) {
        this.itemsVisibleCount = itemsVisibleCount;
        return this;
    }

    public AppCompatTimePickerPopup setLineSpace(float lineSpace) {
     ...
     * 设置默认时间
     */
    public AppCompatTimePickerPopup setDefaultDate(Calendar date) {
        this.date = date;
        return this;
    }
     ...
     * 设置年份范围
     */
    public AppCompatTimePickerPopup setYearRange(int startYear, int endYear) {
     ...
     * 设置可以选择的时间范围
     */
    public AppCompatTimePickerPopup setDateRang(Calendar startDate, Calendar endDate) {
