...
//    private boolean mIsBeingDragged;
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(HVScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY);
    }
...
//                        mVelocityTracker.clear();
                    ...
                    if (dispatchNestedScroll(scrolledDeltaX, scrolledDeltaY, unconsumedX, unconsumedY, mScrollOffset)) {
                        ...
                        if (canScrollVertically()) {
                            if (pulledToY < 0) {
                                mEdgeGlowTop.onPull((float) dy / getHeight(), MotionEventCompat
                                                                                      .getX(ev, activePointerIndex) / getWidth());
                        ...
                        if (canScrollHorizontally()) {
                            if (pulledToX < 0) {
                                mEdgeGlowLeft.onPull((float) dx / getWidth(), MotionEventCompat
                                                                                      .getX(ev, activePointerIndex) / getHeight());
