...
import com.cjf.util.extension.createDrawable
import com.cjf.util.extension.dp2px
...
open class ShapeFrameLayout @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        solid = ta.getColor(R.styleable.ShapeFrameLayout_sfl_solid, solid)
        stroke = ta.getColor(R.styleable.ShapeFrameLayout_sfl_stroke, stroke)
        strokeWidth = ta.getDimensionPixelSize(R.styleable.ShapeFrameLayout_sfl_strokeWidth, strokeWidth)
        corner = ta.getDimensionPixelSize(R.styleable.ShapeFrameLayout_sfl_corner, corner)
