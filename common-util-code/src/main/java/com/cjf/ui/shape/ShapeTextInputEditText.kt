...
import com.cjf.util.extension.sizeDrawable
 ...
 */
open class ShapeTextInputEditText @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
