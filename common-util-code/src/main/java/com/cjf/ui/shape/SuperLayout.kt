...
import kotlinx.android.synthetic.main.simple_super_layout.view.*
...
class SuperLayout @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    var mleftImageSize = this.dp2px(34f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mleftTextSize = this.sp2px(16f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
        }
    var mleftTextMarginLeft = dp2px(8f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
        }
    var mleftTextMarginRight = dp2px(8f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mleftSubTextSize = sp2px(13f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mcenterTextSize = sp2px(15f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mrightTextSize = sp2px(15f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mrightImageSize = dp2px(20f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
        }
    var mrightImageMarginLeft = dp2px(10f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    var mrightImage2Size = dp2px(55f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
        }
    var mrightImage2MarginLeft = dp2px(10f).toInt()
        set(value) {
            field = value
            applyAttr()
            applySelf()
    ...
    init {
        ...
        ta.recycle()
        inflate(context, R.layout.simple_super_layout, this)
        applyAttr()
        applySelf()
    }
