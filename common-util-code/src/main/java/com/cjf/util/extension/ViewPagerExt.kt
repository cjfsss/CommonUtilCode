 ...
 */
fun ViewPager.asCard(pageMargin: Int = ViewUtils.dp2px(context,30.0F).toInt(), padding: Int =  ViewUtils.dp2px(context,45.0F).toInt()): ViewPager {
...
class CardPagerTransformer(context: Context) : ViewPager.PageTransformer {
    private val maxTranslateOffsetX: Int = context.dp2px(180f).toInt()
